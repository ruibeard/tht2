        ...
        <form method="post" action="{{ route('activity.store') }}" id="activityform">
            ...
            <div class="form-row">
                <div class="col-6">
                    ...
                    <input type="date" name="activity_date" class="form-control" form="activityform" value="{{ old('activity_date', $activity->activity_date??'') }}">
                </div>
            </div>
            ...
            <div class="form-row mt-2">
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="outputs[area_cleared_sqm]" value="{{ old('outputs', $activity->outputs??'')['area_cleared_sqm'] ?? null }}">
                </div>
                <div class="form-group">
                    <label>No. Deminers</label>
                    <input class="form-control" type="number" name="outputs[num_deminers]" value="{{ old('outputs', $activity->outputs??'')['num_deminers'] ?? null }}">
                </div>
                <div class="form-group">
                    <label>Minutes worked</label>
                    <input class="form-control" type="number" name="outputs[minutes_worked]" value="{{ old('outputs', $activity->outputs??'')['minutes_worked'] ?? null }}">
                </div>
